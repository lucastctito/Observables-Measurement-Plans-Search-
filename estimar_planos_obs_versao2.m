function [estimativa_total_garantem_supervisao,controle_estimativa,alpha_a_priori, beta_a_priori,alpha_posteriori,beta_posteriori] = estimar_planos_obs_versao2(numero_inicial,qtd_ind,n1,obs_critc,controle_estimativa,alpha_a_priori,beta_a_priori,qtd_barras)
...
total_planos = combntns(qtd_barras, numero_inicial); % ajuste conforme necessário
...
alpha_a_priori = alpha_posteriori;
beta_a_priori = beta_posteriori;
